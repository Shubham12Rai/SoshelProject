...
@section('content')
    ...
    <section>
        ...
        @if (session('statusTermCondition'))
            <div class=" alert-success" role="alert">
            </div>
        @endif
        <form class="form" action="{{ url('/update-term-condition') }}/{{ $termCondition[0]->id }} " method='POST'>
            @csrf
                ...
                <div class="description-part">
                    <div class="row">
                        ...
                        <div class="col-md-10 ck-editor">
                            <textarea class="ckeditor" name="description" id="description" rows="4" cols="50">{{ $termCondition[0]->option_detail }}</textarea>
